...
{{< section-container class="py-20 bg-gray-50" >}}
    <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >}}
            <div class="text-xl">
                Professional software engineer with a passion for AI and cross-platform development.
                <br>
                <br>
                <li>Currently pursuing a Master's in Computer Science while developing innovative applications.</li>
                <li>Dedicated to creating technology that makes a positive impact on people's lives.</li>
                <br>
                <br>
                Education:
                <br>
                ...
                <div class="container">
                    <div class="content">
                        BS - Computer Science (2019)<br>University of Mary Washington
                    </div>
                    <br>
                    <div class="content">
                        MS - Computer Science (Expected 2025)<br>University of Texas at Austin
                    </div>
                </div>
                <br>
            </div>
